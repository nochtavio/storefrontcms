$(document).ready(function () {
        ...
        $.ajax({
          ...
          success: function (result) {
            if (result['result'] === 'r1') {
              ...
              $("#txt_data_modal_price").val(result['modal_price']);
  ...
  add_data = function (id_brand, name, price, sale_price, modal_price, potongan_gold, potongan_silver, potongan_bronze, weight, attribute, description, short_description, info, size_guideline, category, category_child, category_child_, active) {
    $.ajax({
  ...
  edit_data = function (id, id_brand, name, price, sale_price, modal_price, potongan_gold, potongan_silver, potongan_bronze, weight, attribute, description, short_description, info, size_guideline, category, category_child, category_child_, active) {
    $.ajax({

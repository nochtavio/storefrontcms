<ul class="sidebar-menu">
  ...
  <?php
    if(check_menu("Credit_log", $type = 0)){
      ?>
        <li class="<?php echo ($page == "Credit_log") ? "active" : ""; ?>"><a href="<?php echo base_url() ?>credit_log/"><i class="fa fa-money"></i> <span>Credit Log</span> <span id="realtime-creditlog" class="label label-danger" style="display: none;">1</span></a></a></li>
      <?php
    }
  ?>
  <?php
  ...
  <?php
    if(check_menu("Customer_return", $type = 0)){
      ?>
        <li class="<?php echo ($page == "Customer_return") ? "active" : ""; ?>"><a href="<?php echo base_url() ?>customer_return/"><i class="fa fa-history"></i> <span>Customer Return</span> <span id="realtime-customerreturn" class="label label-danger" style="display: none;">1</span></a></a></li>
      <?php
    }
  ?>
  <?php
  ...
  <?php
    if(check_menu("Order", $type = 0)){
      ?>
        <li class="<?php echo ($page == "Order") ? "active" : ""; ?>"><a href="<?php echo base_url() ?>order/"><i class="fa fa-shopping-bag"></i> <span>Order</span> <span id="realtime-order" class="label label-danger" style="display: none;">1</span></a></li>
      <?php
    }
  ?>
  <?php
  ...
  <?php
    if(check_menu("Reseller_request", $type = 0)){
      ?>
        <li class="<?php echo ($page == "Reseller_request") ? "active" : ""; ?>"><a href="<?php echo base_url() ?>reseller_request/"><i class="fa fa-tty"></i> <span>Reseller Request</span> <span id="realtime-resellerrequest" class="label label-danger" style="display: none;">1</span></a></a></li>
      <?php
    }
  ?>
  <?php

<input type="hidden" id="txt_id_category_child" name="txt_id_category_child" value="<?php echo $id_category_child ?>" />

<div class="row" style="margin-bottom:5px;">
  <div class="col-xs-12">
    <div id="main_panel" class="panel">
      <header class="panel-heading">
        <?php echo $category_child_name ?> Products List
      </header>
        ...
        <div class="box-tools m-b-15">
          <div class="input-group">
            ...
            <div class="input-group-btn">
              <a id="btn_add_data" href="#modal_data" data-toggle="modal" class="btn btn-info btn-sm">Add Product</a>
            </div>
            <div class="input-group-btn">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label for="txt_data_name" class="col-lg-3 col-sm-3 control-label">Product Name</label>
            <div class="col-lg-9 col-sm-9">
              <input type="hidden" class="form-control form_data" id="txt_data_products_id">
              <input type="text" class="form-control form_data" id="txt_data_name" placeholder="Type products name">
            </div>
          </div>
          <div class="form-group">

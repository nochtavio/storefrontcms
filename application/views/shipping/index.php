      ...
      <div class="panel-body table-responsive">
        <div class="box-tools m-b-15">
          <div class="input-group">
            <input id="txt_name" name="txt_name" type="text" class="form-control input-sm" style="margin-right: 7px;width: 150px;" placeholder="Filter Kabupaten Name">
            ...
            <select id="sel_order" name="sel_order" class="form-control input-sm" style="margin-right: 7px;width: 200px;">
              <option value="-1">Order by Kabupaten A-Z</option>
              <option value="1">Order by Kabupaten Z-A</option>
            </select>
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label for="txt_data_name" class="col-lg-3 col-sm-3 control-label">Kabupaten</label>
            <div class="col-lg-9 col-sm-9">
              <input type="text" class="form-control form_data" id="txt_data_name" placeholder="" readonly="">
            </div>
          </div>
          <div class="form-group">
            <label for="txt_data_reguler" class="col-lg-3 col-sm-3 control-label">Reguler</label>
            <div class="col-lg-9 col-sm-9">
              <input type="text" class="form-control form_data" id="txt_data_reguler" placeholder="Enter JNE Regular price">
            </div>
          </div>
          <div class="form-group">
            <label for="txt_data_oke" class="col-lg-3 col-sm-3 control-label">OKE</label>
            <div class="col-lg-9 col-sm-9">
              <input type="text" class="form-control form_data" id="txt_data_oke" placeholder="Enter JNE OKE price">
            </div>
          </div>
          <div class="form-group">
            <label for="txt_data_yes" class="col-lg-3 col-sm-3 control-label">YES</label>
            <div class="col-lg-9 col-sm-9">
              <input type="text" class="form-control form_data" id="txt_data_yes" placeholder="Enter JNE YES price">
            </div>
          </div>
          <div class="form-group">
